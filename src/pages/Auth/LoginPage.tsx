...
export const LoginPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(99,102,241,0.15),transparent_45%),radial-gradient(circle_at_20%_40%,_rgba(16,185,129,0.12),transparent_35%)]" />
      <div className="relative flex min-h-screen items-center justify-center px-4 py-8">
        <div className="w-full max-w-lg rounded-[32px] border border-slate-800/80 bg-slate-900/85 p-8 text-slate-50 shadow-[0_30px_120px_rgba(0,0,0,0.65)] backdrop-blur-xl">
          <div className="mb-6 flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-xl font-semibold text-white">Masuk untuk dapatkan klip gratis</p>
          ...
          <div className="space-y-4">
            <button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  // Redirect flow will continue after returning; show info instead of error
            ...
            <p className="text-center text-[11px] text-slate-500">
              Dengan masuk Anda menyetujui kebijakan privasi dan penggunaan AI Vibing Clip.
            </p>
          </div>
        </div>
      </div>
